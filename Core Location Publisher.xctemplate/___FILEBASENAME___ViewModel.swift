...
/// **___VARIABLE_basename___ViewModel** ist a ViewModel for a Standard LocationManager
/// which delivers the coordinate of the location and the heading over time.
/// It can be easily enhanced

class ___VARIABLE_basename___ViewModel: NSObject, ObservableObject {
...
extension ___VARIABLE_basename___ViewModel {
...
extension ___VARIABLE_basename___ViewModel: CLLocationManagerDelegate {
